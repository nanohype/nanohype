...
/**
 * Training provider registry. Each provider module registers itself at
 * import time with a factory function, so adding a new provider is just
 * "create a file, register it" — no switch statements or central wiring
 * needed.
 */

const providers = new Map<string, () => TrainingProvider>();
 ...
 */
export function getProvider(name: string): TrainingProvider {
