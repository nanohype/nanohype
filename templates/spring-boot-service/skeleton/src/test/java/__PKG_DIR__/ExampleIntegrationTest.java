...
/**
 * Full-stack integration test against a real PostgreSQL container — exercises Flyway migrations,
 * Hibernate schema validation, and JPA repository flow. Uses the default profile (not the H2-based
 * `test` profile) so that the production migration path is verified end-to-end.
 */
@SpringBootTest
@Testcontainers
