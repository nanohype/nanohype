...
//
// In-memory payment provider for testing and local development.
// Tracks customers, subscriptions, and invoices in arrays. Returns
// deterministic fake IDs (mock-cus-1, mock-sub-1, etc.) so tests
// can assert on them without randomness.
//
