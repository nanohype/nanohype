...
- **Infrastructure** (`infrastructure`) — k8s-app-tenant (primary), landing-zone-component, eks-addon, k8s-deploy (generic-cluster), monorepo, monitoring-stack, infra-druid
