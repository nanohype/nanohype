...
- **Standards manifests** — each `standards/*.json` validates against [`schemas/standards.schema.json`](schemas/standards.schema.json). One file per `kind` discriminator value.
