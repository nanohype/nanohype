...
**Audience:** Template authors, catalog maintainers. For consumer implementors, see the **[Consumer Implementation Guide](consumer-guide.md)** — the actionable doc with the scaffolding algorithm, composite orchestration, and catalog integration.
